...
(lib.bg = function() {
	this.initialize(img._429_2_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1292,1400);


(lib.book1 = function() {
	this.initialize(img._429_2_book1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,575,1287);


(lib.book2 = function() {
	this.initialize(img._429_2_book2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,927,996);


(lib.ch_base = function() {
	this.initialize(img._429_2_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1292,1400);


(lib.ch_face13 = function() {
	this.initialize(img._429_2_ch_face13);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face2 = function() {
	this.initialize(img._429_2_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face3 = function() {
	this.initialize(img._429_2_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face4 = function() {
	this.initialize(img._429_2_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face5 = function() {
	this.initialize(img._429_2_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face6 = function() {
	this.initialize(img._429_2_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.ch_face7 = function() {
	this.initialize(img._429_2_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,320,320);


(lib.finish = function() {
	this.initialize(img._429_2_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._429_2_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.sun_light = function() {
	this.initialize(img._429_2_sun_light);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,48,284);


(lib.tie_fp = function() {
	this.initialize(img._429_2_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._429_2_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
(lib.ch4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.instance = new lib.book2();
	this.instance.parent = this;
	this.instance.setTransform(-231.75,-249,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ch4, new cjs.Rectangle(-231.7,-249,463.5,498), null);
...
(lib.ch3 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-143.75,-321.75,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ch3, new cjs.Rectangle(-143.7,-321.7,287.5,643.5), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_base, new cjs.Rectangle(-120,-396,646,700), null);
...
(lib.ch3_anim = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{def:0,nod:3,pop:28,swing:37});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(3).call(this.frame_3).wait(24).call(this.frame_27).wait(1).call(this.frame_28).wait(8).call(this.frame_36).wait(1).call(this.frame_37).wait(23).call(this.frame_60).wait(1));

	// effect
	this.instance = new lib.drop1_v2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-41.55,-215.5,0.7336,0.7336);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(42).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7494,x:-57.65,y:-221.2,alpha:0.4141},0).wait(1).to({regX:0,regY:-0.1,rotation:-44.9992,x:-65.05,y:-223.9,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,regY:0,rotation:0,x:-41.55,y:-215.5,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7494,x:-57.65,y:-221.2,alpha:0.4141},0).wait(1).to({regX:0,regY:-0.1,rotation:-44.9992,x:-65.05,y:-223.9,alpha:0.2188},0).to({_off:true},1).wait(12));

	// effect
	this.instance_1 = new lib.drop2_v2("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-42.7,-209.35,0.6222,0.6222,14.9994);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(42).to({_off:false},0).wait(1).to({scaleX:0.7058,scaleY:0.7058,rotation:-18.7496,x:-62.4899,y:-206.4626,alpha:0.4141},0).wait(1).to({scaleX:0.7336,scaleY:0.7336,rotation:-29.9993,x:-69.1,y:-205.45,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.6222,scaleY:0.6222,rotation:14.9994,x:-42.7,y:-209.35,alpha:1},0).wait(1).to({scaleX:0.7058,scaleY:0.7058,rotation:-18.7496,x:-62.5,y:-209.2,alpha:0.4141},0).wait(1).to({scaleX:0.7336,scaleY:0.7336,rotation:-29.9993,x:-69.1,y:-209.15,alpha:0.2188},0).to({_off:true},1).wait(12));

	// レイヤー_1
	this.instance_2 = new lib.ch3();
	this.instance_2.parent = this;
	this.instance_2.setTransform(0,0,0.74,0.74);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(4).to({y:0.387},0).wait(1).to({y:1.8532},0).wait(1).to({y:4.1468},0).wait(1).to({y:5.613},0).wait(1).to({y:6},0).wait(1).to({y:5.613},0).wait(1).to({y:4.1468},0).wait(1).to({y:1.8532},0).wait(1).to({y:0.387},0).wait(1).to({y:0},0).wait(16).to({y:-5},0).wait(1).to({y:-10},0).wait(1).to({y:-7.3525},0).wait(1).to({y:0.3525},0).wait(1).to({y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(2).to({regX:4.3,regY:237.1,x:3.2,y:175.45},0).wait(1).to({regX:0,regY:0,rotation:-0.0183,x:-0.0556,y:0.0011},0).wait(1).to({rotation:-0.0815,x:-0.2483,y:0.0051},0).wait(1).to({rotation:-0.2038,x:-0.6211,y:0.0134},0).wait(1).to({rotation:-0.3908,x:-1.1909,y:0.0276},0).wait(1).to({rotation:-0.61,x:-1.8588,y:0.0467},0).wait(1).to({rotation:-0.797,x:-2.4285,y:0.0649},0).wait(1).to({rotation:-0.9193,x:-2.8012,y:0.0779},0).wait(1).to({rotation:-0.9825,x:-2.9937,y:0.0849},0).wait(1).to({regX:4.3,regY:237.1,rotation:-1.0008,x:3.2,y:175.4},0).wait(1).to({regX:0,regY:0,rotation:-0.9696,x:-2.9552,y:0.0465},0).wait(1).to({rotation:-0.8575,x:-2.6134,y:0.0343},0).wait(1).to({rotation:-0.64,x:-1.9507,y:0.0125},0).wait(1).to({rotation:-0.3608,x:-1.0996,y:-0.0118},0).wait(1).to({rotation:-0.1433,x:-0.4368,y:-0.0278},0).wait(1).to({rotation:-0.0311,x:-0.0949,y:-0.0351},0).wait(1).to({regX:4.3,regY:237.1,rotation:0,x:3.2,y:175.45},0).wait(8));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-113.5,-248.1,221,492.2);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("");
	this.shape_1.setTransform(0,0.425);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("");
	this.shape_2.setTransform(-16,0.6);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(126.1,72.05,0.77,0.3264,58.0017,0,0,0.3,-0.1);

	this.instance_1 = new lib.uru_set();
	this.instance_1.parent = this;
	this.instance_1.setTransform(113.15,74.6,1.07,0.4536,-1.9992,0,0,0.2,-0.1);

	this.instance_2 = new lib.uru_set();
	this.instance_2.parent = this;
	this.instance_2.setTransform(126.3,65,1.9814,0.84,71.9989,0,0,0.1,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance,p:{regX:0.3,regY:-0.1,scaleX:0.77,scaleY:0.3264,rotation:58.0017,skewX:0,skewY:0,x:126.1,y:72.05}}]},3).to({state:[]},1).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance,p:{regX:0.3,regY:-0.1,scaleX:0.77,scaleY:0.3264,rotation:58.0017,skewX:0,skewY:0,x:126.1,y:72.05}}]},8).to({state:[]},1).to({state:[{t:this.instance,p:{regX:0,regY:0,scaleX:0.9005,scaleY:0.5503,rotation:0,skewX:26.0791,skewY:25.8338,x:87,y:41.9}}]},6).wait(1));

	// moisture_righteye
	this.instance_3 = new lib.uru_set();
	this.instance_3.parent = this;
	this.instance_3.setTransform(64.85,57.15,0.71,0.3115,62.0002,0,0,0.8,3.7);

	this.instance_4 = new lib.uru_set();
	this.instance_4.parent = this;
	this.instance_4.setTransform(44.5,61.75,0.96,0.4212,161.0025,0,0,0.8,3.8);

	this.instance_5 = new lib.uru_set();
	this.instance_5.parent = this;
	this.instance_5.setTransform(60.9,51.85,2.1859,0.9592,74.1719,0,0,0.7,4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3,p:{regX:0.8,regY:3.7,scaleX:0.71,scaleY:0.3115,rotation:62.0002,skewX:0,skewY:0,x:64.85,y:57.15}}]},3).to({state:[]},1).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3,p:{regX:0.8,regY:3.7,scaleX:0.71,scaleY:0.3115,rotation:62.0002,skewX:0,skewY:0,x:64.85,y:57.15}}]},8).to({state:[]},1).to({state:[{t:this.instance_3,p:{regX:0.7,regY:4.2,scaleX:1.0632,scaleY:0.5296,rotation:0,skewX:32.5646,skewY:37.1205,x:34.65,y:40.95}}]},6).wait(1));
	...
	this.instance_11 = new lib.ch_face7();
...
(lib.ch4_anim = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{"def":0,"nod":3,"pop":14});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(3).call(this.frame_3).wait(10).call(this.frame_13).wait(1).call(this.frame_14).wait(21).call(this.frame_35).wait(1));

	// effect
	this.instance = new lib.laugh("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-38.25,-174.55,1.4184,1.4184,77.8961,0,0,-30.3,20.4);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(14).to({_off:false},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,x:-40.9,y:-175.55,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.4,x:-38.25,y:-174.55,alpha:0,startPosition:19},0).to({_off:true},1).wait(2));

	// レイヤー_1
	this.instance_1 = new lib.ch4();
	this.instance_1.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({y:0.387},0).wait(1).to({y:1.8532},0).wait(1).to({y:4.1468},0).wait(1).to({y:5.613},0).wait(1).to({y:6},0).wait(1).to({y:5.613},0).wait(1).to({y:4.1468},0).wait(1).to({y:1.8532},0).wait(1).to({y:0.387},0).wait(1).to({y:0},0).wait(2).to({y:-5},0).wait(1).to({y:-10},0).wait(1).to({y:-7.3525},0).wait(1).to({y:0.3525},0).wait(1).to({y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-231.7,-259,463.5,514);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.face_blink_ary = [1, 1, 1, 1, 0, 0, 0, 1, 1, 1, 0, 0, 1, 1, 1]; 
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("AHIFlQh1gagsgqQgegdgRhNQgRhKgPgJQgVgOguAEQgpAFgCgBQhXAch6AQQj3Agi4g9QjGhCAAh+QAAgzAhgyQAegvAvgfQBag9CdggQChghA+AiQAtAZBgCBQBcB8AZAKQASAHAsgYQATgKBKgtQCFhUAyAOQA9ARBrCNQBiB/AMAzQAQBGgHA8QgLBbhEAQQgfAIgmAAQg4AAhHgQg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:83.1815,y:62.0444}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
...
p.nominalBounds = new cjs.Rectangle(-232,-192,646,700);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-232.95,-152.1);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-353,-548.1,663.2,700.1);
...
(lib.bg_zoom_half = function(mode,startPosition,loop) {
	...
	// レイヤー_2
	this.ch4 = new lib.ch4_anim();
	this.ch4.name = "ch4";
	this.ch4.parent = this;
	this.ch4.setTransform(143.15,451);

	this.timeline.addTween(cjs.Tween.get(this.ch4).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-88.6,0,734.6,700);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-425.65,-575.1,1.1947,1.3897,0,-7.2096,-22.8033,-42.5,-92.7);
	this.instance.alpha = 0.1484;
	this.instance.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(442).to({scaleX:1.6472,scaleY:1.9152,skewX:3.0742,skewY:-12.7502,x:-408.75,y:-621.25},0).wait(20));

	// effect2
	this.instance_1 = new lib.drop1_v2("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-92.35,-373.75,1.1645,1.1645);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-117.95,y:-382.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-129.6,y:-387.05,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-92.35,y:-373.75,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-117.95,y:-382.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-129.6,y:-387.05,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,rotation:0,x:-92.35,y:-373.75,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-117.95,y:-382.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-129.6,y:-387.05,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-92.35,y:-373.75,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-117.95,y:-382.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-129.6,y:-387.05,alpha:0.2188},0).to({_off:true},1).wait(130));

	// effect
	this.instance_2 = new lib.spread_flower_pink("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-38.2,-279.6,1.4808,1.4808);

	this.instance_3 = new lib.good_effect("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(-38.2,-279.6,1.481,1.481);

	this.instance_4 = new lib.notice();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-118.4,-358.65,1.4232,1.4232,0,-154.0047,25.9953,-29.1,20.5);
	this.instance_4._off = true;

	this.instance_5 = new lib.laugh("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-130.8,-364.35,1.4204,1.4204,35.8424,0,0,-30.3,20.6);
	this.instance_5._off = true;

	this.instance_6 = new lib.chord("synched",0,false);
	this.instance_6.parent = this;
	this.instance_6.setTransform(-103,-282,1.0029,1.0029,-61.4995,0,0,-23.4,76.9);

	this.instance_7 = new lib.question();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-103.65,-366.6,1.053,1.053,-28.4906);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.instance_8 = new lib.mc_exclamation("synched",0,false);
	this.instance_8.parent = this;
	this.instance_8.setTransform(-105.9,-381.3,1.0929,1.0929,-29.9996,0,0,0,0.1);

	this.instance_9 = new lib.drop1a("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-100.4,-362.7,1,1,0,0,0,-0.5,0.2);
	this.instance_9._off = true;

	this.instance_10 = new lib.drop2_v2("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-94.15,-364,0.9876,0.9876,14.9998);
	this.instance_10._off = true;

	this.instance_11 = new lib.shock("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(-103.75,-367.65,1.3878,1.3878,-121.2396);

	this.instance_12 = new lib.sigh("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(-81.25,-213.25);
	this.instance_12.alpha = 0.6016;
	this.instance_12._off = true;

	this.instance_13 = new lib.heart("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(-103.05,-322.85,0.4532,0.4532);
	this.instance_13._off = true;

	this.instance_14 = new lib.angry("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(34.9,-342.95,0.5276,0.5276);
	this.instance_14._off = true;

	this.instance_15 = new lib.mc_punpun();
	this.instance_15.parent = this;
	this.instance_15.setTransform(-96.15,-392.1,1.1377,1.1377);

	this.instance_16 = new lib.concent_wrapper("synched",0,false);
	this.instance_16.parent = this;
	this.instance_16.setTransform(-38.45,-280.15,1,1,0,0,0,-0.5,-0.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,x:-118,y:-358.4,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:-118.4,y:-358.65,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,regY:20.4,scaleX:1.187,scaleY:1.187,skewX:-169.8305,skewY:10.1695,x:-109.9,y:-369.65,alpha:1},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-109.5,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-109.9,alpha:0},0).to({_off:true},1).wait(303));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(160).to({_off:false},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-133.3,y:-363.5,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-130.8,y:-364.35,alpha:0,startPosition:19},0).to({_off:true},1).wait(282));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:-110.6,y:-380,alpha:0.5556},0).wait(1).to({x:-114.7,y:-388.25,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-116,y:-391.3,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-115.75,y:-390.35},0).wait(1).to({x:-114.75,y:-388.5},0).wait(1).to({x:-113.05,y:-385.35},0).wait(1).to({regX:0,regY:0,x:-110.6,y:-381.3},0).to({x:-111.35,y:-382.65},2).wait(8).to({regX:-0.2,regY:0.2,x:-111.1,y:-381.75,alpha:0.9298},0).wait(1).to({x:-110.05,y:-379.8,alpha:0.692},0).wait(1).to({x:-108.45,y:-376.9,alpha:0.339},0).wait(1).to({x:-107.3,y:-374.75,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-106.85,y:-374.45,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:-104.1,y:-366.2},0).wait(1).to({regX:-0.2,regY:0.2,x:-111.05,y:-379.6,alpha:0.5556},0).wait(1).to({x:-115.15,y:-387.85,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-116.45,y:-390.9,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-116.2,y:-389.95},0).wait(1).to({x:-115.2,y:-388.1},0).wait(1).to({x:-113.5,y:-384.95},0).wait(1).to({regX:0,regY:0,x:-111.05,y:-380.9},0).to({x:-111.8,y:-382.25},2).wait(3).to({regX:-0.2,regY:0.2,x:-111.55,y:-381.35,alpha:0.9298},0).wait(1).to({x:-110.5,y:-379.4,alpha:0.692},0).wait(1).to({x:-108.9,y:-376.5,alpha:0.339},0).wait(1).to({x:-107.75,y:-374.35,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-107.3,y:-374.05,alpha:0},0).to({_off:true},1).wait(215));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:-99.4,y:-359},0).wait(1).to({y:-355.15},0).wait(1).to({y:-351.9},0).wait(1).to({y:-349.25},0).wait(1).to({y:-347.15},0).wait(1).to({y:-345.65},0).wait(1).to({y:-344.75},0).wait(1).to({regX:-0.5,regY:0.2,x:-100.4,y:-343.7},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:-99.4,y:-344.5,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:-100.4,y:-343.7,alpha:0},0).to({_off:true},1).wait(173));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-125.575,y:-359.3875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-136.05,y:-357.85,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-94.15,y:-364,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-125.575,y:-363.775,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-136.05,y:-363.7,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-94.15,y:-364,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-125.575,y:-359.3875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-136.05,y:-357.85,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-94.15,y:-364,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-125.575,y:-363.775,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-136.05,y:-363.7,alpha:0.2188},0).to({_off:true},1).wait(130));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(351).to({_off:false},0).wait(1).to({x:-82.25,y:-212.25,alpha:1},0).wait(1).to({regX:0.9,x:-82.35,y:-211.3,alpha:0.8965},0).wait(1).to({x:-83.7,y:-210.1,alpha:0.7636},0).wait(1).to({x:-85.3,y:-208.65,alpha:0.6048},0).wait(1).to({x:-87.1,y:-207.05,alpha:0.4229},0).wait(1).to({x:-89.1,y:-205.2,alpha:0.2205},0).wait(1).to({regX:0,x:-92.25,y:-203.25,alpha:0},0).to({_off:true},1).wait(103));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-104.8,y:-337},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-108.05,y:-342.85},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-105.5,y:-340.7},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-104.95,y:-337.45},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-106.05,y:-332.85},0).to({scaleX:1,scaleY:1,x:-107.05,y:-336.85},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:-104.45,y:-335.85,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:-106.05,y:-336.6,alpha:0.1016},0).to({_off:true},1).wait(79));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:-30,regY:-198.1,x:-30,y:-206.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-207.3},0).wait(1).to({y:-204.55},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-203.6},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-203.85},0).wait(1).to({y:-196.9},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-194.85},0).wait(1).to({y:-197.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-203.05},0).wait(1).to({y:-197.15},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-203.05},0).wait(1).to({y:-197.15},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-197.2},0).wait(1).to({y:-197.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-207.1},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-211.05},0).wait(1).to({y:-207.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-196.1},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-198.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-207.1},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-211.05},0).wait(1).to({y:-207.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-196.1},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-198.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-30,regY:-198.1,x:-30,y:-197.5},0).wait(1).to({y:-195.1},0).wait(1).to({y:-192.75},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-192.75},0).wait(1).to({y:-195.1},0).wait(1).to({y:-197.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-30,regY:-198.1,x:-30,y:-197.95},0).wait(1).to({y:-197.4},0).wait(1).to({y:-196.3},0).wait(1).to({y:-194.95},0).wait(1).to({y:-193.85},0).wait(1).to({y:-193.3},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-193.3},0).wait(1).to({y:-193.85},0).wait(1).to({y:-194.95},0).wait(1).to({y:-196.3},0).wait(1).to({y:-197.4},0).wait(1).to({y:-197.95},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-193.35},0).wait(1).to({y:-196.9},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-195.9},0).wait(1).to({y:-197.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-30,regY:-198.1,rotation:-0.0253,x:-30.15,y:-198.05},0).wait(1).to({rotation:-0.1129,x:-30.75,y:-197.7},0).wait(1).to({rotation:-0.2845,x:-31.95,y:-197.05},0).wait(1).to({rotation:-0.5565,x:-33.8,y:-196.05},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-36.15,y:-194.75},0).wait(1).to({rotation:-1.2075,x:-38.25,y:-193.55},0).wait(1).to({rotation:-1.4141,x:-39.7,y:-192.7},0).wait(1).to({rotation:-1.5201,x:-40.4,y:-192.3},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:-5.3,y:5},0).wait(1).to({regX:-30,regY:-198.1,rotation:-1.5305,x:-40.5,y:-192.3},0).wait(1).to({rotation:-1.4624,x:-40,y:-192.55},0).wait(1).to({rotation:-1.3309,x:-39.1,y:-193.05},0).wait(1).to({rotation:-1.121,x:-37.7,y:-193.9},0).wait(1).to({rotation:-0.8372,x:-35.7,y:-194.95},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:-33.6,y:-196.15},0).wait(1).to({rotation:-0.2881,x:-31.9,y:-197.1},0).wait(1).to({rotation:-0.1291,x:-30.8,y:-197.75},0).wait(1).to({rotation:-0.0467,x:-30.2,y:-198.05},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-30,regY:-198.1,rotation:-0.0253,x:-30.1,y:-198.05},0).wait(1).to({rotation:-0.1129,x:-30.6,y:-197.7},0).wait(1).to({rotation:-0.2845,x:-31.5,y:-197.05},0).wait(1).to({rotation:-0.5565,x:-32.85,y:-196.05},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-34.65,y:-194.75},0).wait(1).to({rotation:-1.2075,x:-36.25,y:-193.55},0).wait(1).to({rotation:-1.4141,x:-37.4,y:-192.7},0).wait(1).to({rotation:-1.5201,x:-37.9,y:-192.3},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:-2.75,y:5},0).wait(1).to({regX:-30,regY:-198.1,rotation:-1.5302,x:-38,y:-192.3},0).wait(1).to({rotation:-1.461,x:-37.6,y:-192.55},0).wait(1).to({rotation:-1.3276,x:-36.95,y:-193.05},0).wait(1).to({rotation:-1.1146,x:-35.8,y:-193.9},0).wait(1).to({rotation:-0.8266,x:-34.3,y:-194.95},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.5189,x:-32.7,y:-196.2},0).wait(1).to({rotation:-0.2693,x:-31.4,y:-197.1},0).wait(1).to({rotation:-0.1079,x:-30.5,y:-197.75},0).wait(1).to({rotation:-0.0243,x:-30.1,y:-198.05},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:-30,regY:-198.1,x:-30,y:-203.65},0).wait(1).to({y:-205.55},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-205.45},0).wait(1).to({y:-203.35},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:-30,regY:-198.1,x:-30,y:-206.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-207.3},0).wait(1).to({y:-204.55},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:-30,regY:-198.1,rotation:-0.0253,x:-30.1,y:-198},0).wait(1).to({rotation:-0.1129,x:-30.45,y:-197.4},0).wait(1).to({rotation:-0.2845,x:-31.15,y:-196.3},0).wait(1).to({rotation:-0.5565,x:-32.25,y:-194.6},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-33.7,y:-192.4},0).wait(1).to({rotation:-1.2075,x:-34.95,y:-190.4},0).wait(1).to({rotation:-1.4141,x:-35.85,y:-189.05},0).wait(1).to({rotation:-1.5201,x:-36.25,y:-188.4},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:-1.05,y:9},0).wait(1).to({regX:-30,regY:-198.1,rotation:-1.5305,x:-36.3,y:-188.35},0).wait(1).to({rotation:-1.4624,x:-36,y:-188.8},0).wait(1).to({rotation:-1.3309,x:-35.45,y:-189.6},0).wait(1).to({rotation:-1.121,x:-34.65,y:-191},0).wait(1).to({rotation:-0.8372,x:-33.45,y:-192.85},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:-32.2,y:-194.8},0).wait(1).to({rotation:-0.2881,x:-31.15,y:-196.4},0).wait(1).to({rotation:-0.1291,x:-30.5,y:-197.45},0).wait(1).to({rotation:-0.0467,x:-30.15,y:-198},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-30,regY:-198.1,rotation:-0.147,x:-30.35,y:-197.55},0).wait(1).to({rotation:-0.7239,x:-31.6,y:-195.35},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.3727,x:-33,y:-192.9},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(18).to({regX:-30,regY:-198.1,rotation:-1.4913,x:-33.25,y:-192.4},0).wait(1).to({rotation:-1.2701,x:-32.8,y:-193.35},0).wait(1).to({rotation:-0.8372,x:-31.85,y:-194.95},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:-30.85,y:-196.8},0).wait(1).to({rotation:-0.094,x:-30.25,y:-197.85},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-30,regY:-198.1,rotation:-0.0894,x:-30.2,y:-197.8},0).wait(1).to({rotation:-0.4358,x:-30.95,y:-196.45},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.0316,x:-32.25,y:-194.2},0).wait(1).to({rotation:-1.4426,x:-33.15,y:-192.6},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(8).to({regX:-30,regY:-198.1,rotation:-1.4913,x:-33.25,y:-192.4},0).wait(1).to({rotation:-1.2701,x:-32.8,y:-193.35},0).wait(1).to({rotation:-0.8372,x:-31.85,y:-194.95},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:-30.85,y:-196.8},0).wait(1).to({rotation:-0.094,x:-30.25,y:-197.85},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-206.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-207.3},0).wait(1).to({y:-204.55},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-30,regY:-198.1,x:-32.75,y:-190.35},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:-30,regY:-198.1,x:-30,y:-185.85},0).wait(1).to({y:-188.8},0).wait(1).to({y:-193.75},0).wait(1).to({y:-197.2},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-197.1},0).wait(1).to({y:-191.15},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:-30,regY:-198.1,x:-30,y:-190.3},0).wait(1).to({y:-194.6},0).wait(1).to({y:-198.9},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-198.6},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-30,regY:-198.1,x:-30,y:-204.8},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-204.95},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-206.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-207.3},0).wait(1).to({y:-204.55},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-30,regY:-198.1,x:-32.75,y:-190.35},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:-30,regY:-198.1,x:-30,y:-187.35},0).wait(1).to({y:-195.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-199.1},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-198.25},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-197.6},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-30,regY:-198.1,x:-30,y:-197.5},0).wait(1).to({y:-195.1},0).wait(1).to({y:-192.75},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-192.7},0).wait(1).to({y:-193},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:-30,regY:-198.1,x:-30,y:-193.5},0).wait(1).to({y:-195},0).wait(1).to({y:-197.25},0).wait(1).to({y:-198.7},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-198.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-205.7},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-207.3},0).wait(1).to({y:-204.55},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:-30,regY:-198.1,x:-30,y:-205.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:-30,regY:-198.1,x:-30,y:-206.1},0).wait(1).to({y:-200.1},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:-30,regY:-198.1,x:-30,y:-193.45},0).wait(1).to({y:-194.65},0).wait(1).to({y:-196.6},0).wait(1).to({y:-197.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-203.05},0).wait(1).to({y:-197.15},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-203.05},0).wait(1).to({y:-197.15},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-197.2},0).wait(1).to({y:-197.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-30,regY:-198.1,x:-27,y:-194.7},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:-30,regY:-198.1,x:-30.85,y:-188.65},0).wait(1).to({x:-30.2,y:-188.25},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:-30,regY:-198.1,x:-30,y:-188.8},0).wait(1).to({y:-191.25},0).wait(1).to({y:-194.95},0).wait(1).to({y:-197.45},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(11).to({regX:-30,regY:-198.1,x:-30,y:-197.5},0).wait(1).to({y:-195.1},0).wait(1).to({y:-192.75},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-30,regY:-198.1,x:-30,y:-192.75},0).wait(1).to({y:-195.1},0).wait(1).to({y:-197.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(12));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-456.9,-1071.6,826.0999999999999,1242.1999999999998);
...
// stage content:
(lib._429_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:146,scene2:147,end2:261,scene3:262,end3:375,scene4:376,end4:507,scene5:508,end5:608,scene6:609,end6:704,scene7:705,end7:828});
	...
	this.frame_15 = function() {
		exportRoot._g.m1 = "みんな元気になってよかった♪";
		exportRoot._g.m2 = "";
		exportRoot._g.m3 = "";
		exportRoot._g.m4 = "";
		exportRoot._u.setText();
	...
	this.frame_262 = function() {
		exportRoot._g.m1 = exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];;
		exportRoot._g.m2 = "";
		exportRoot._g.m3 = "";
		exportRoot._g.m4 = "";
		exportRoot._u.setText();
	...
	this.frame_293 = function() {
		exportRoot._g.m2 = "ちょっとﾄﾞｷﾄﾞｷするよ｡";
		exportRoot._u.setText();
	...
	this.frame_388 = function() {
		exportRoot._g.m1 = "……あっ! ﾌﾟﾛﾃﾞｭｰｻｰだ! ";
		exportRoot._u.setText();
	...
	this.frame_434 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "たﾌﾟﾛﾃﾞｭｰｻｰだよっ｡";
		exportRoot._u.setText();
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(10).call(this.frame_25).wait(19).call(this.frame_44).wait(42).call(this.frame_86).wait(22).call(this.frame_108).wait(23).call(this.frame_131).wait(15).call(this.frame_146).wait(1).call(this.frame_147).wait(13).call(this.frame_160).wait(19).call(this.frame_179).wait(26).call(this.frame_205).wait(16).call(this.frame_221).wait(10).call(this.frame_231).wait(30).call(this.frame_261).wait(1).call(this.frame_262).wait(31).call(this.frame_293).wait(27).call(this.frame_320).wait(12).call(this.frame_332).wait(43).call(this.frame_375).wait(1).call(this.frame_376).wait(12).call(this.frame_388).wait(21).call(this.frame_409).wait(12).call(this.frame_421).wait(13).call(this.frame_434).wait(35).call(this.frame_469).wait(21).call(this.frame_490).wait(17).call(this.frame_507).wait(1).call(this.frame_508).wait(16).call(this.frame_524).wait(21).call(this.frame_545).wait(8).call(this.frame_553).wait(11).call(this.frame_564).wait(4).call(this.frame_568).wait(17).call(this.frame_585).wait(23).call(this.frame_608).wait(1).call(this.frame_609).wait(10).call(this.frame_619).wait(24).call(this.frame_643).wait(19).call(this.frame_662).wait(1).call(this.frame_663).wait(22).call(this.frame_685).wait(19).call(this.frame_704).wait(1).call(this.frame_705).wait(16).call(this.frame_721).wait(33).call(this.frame_754).wait(19).call(this.frame_773).wait(17).call(this.frame_790).wait(18).call(this.frame_808).wait(20).call(this.frame_828).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(833));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(828).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(833));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(814));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(818));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({_off:true},15).wait(818));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(733).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(60));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},773).wait(60));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(773).to({_off:false},0).wait(60));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(773).to({_off:false},0).wait(60));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(761).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(60));
	...
	this.instance_11.parent = this;
	this.instance_11.setTransform(121,155,1,1,0,0,0,1,0);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(15).to({_off:false},0).to({alpha:0},3).to({_off:true},1).wait(814));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(705).to({_off:false},0).to({alpha:0.0117},7).to({_off:true},1).wait(120));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(15).to({_off:false},0).wait(818));

	// ch3
	this.ch3 = new lib.ch3_anim();
	this.ch3.name = "ch3";
	this.ch3.parent = this;
	this.ch3.setTransform(-771.95,318.75);

	this.timeline.addTween(cjs.Tween.get(this.ch3).wait(15).to({scaleX:0.7101,scaleY:0.7101,x:218.4,y:166.45},0).wait(1).to({regX:-3,regY:-2,scaleX:0.71,scaleY:0.71,x:216.2,y:165},0).wait(1).to({scaleX:0.7096,scaleY:0.7096,x:216.15},0).wait(1).to({scaleX:0.7088,scaleY:0.7088,x:216},0).wait(1).to({scaleX:0.7078,scaleY:0.7078,x:215.9},0).wait(1).to({scaleX:0.7063,scaleY:0.7063,x:215.65},0).wait(1).to({scaleX:0.7044,scaleY:0.7044,x:215.35,y:164.95},0).wait(1).to({scaleX:0.7021,scaleY:0.7021,x:214.95},0).wait(1).to({scaleX:0.6993,scaleY:0.6993,x:214.5},0).wait(1).to({scaleX:0.6959,scaleY:0.6959,x:213.95,y:164.9},0).wait(1).to({scaleX:0.692,scaleY:0.692,x:213.3,y:164.85},0).wait(1).to({scaleX:0.6876,scaleY:0.6876,x:212.6,y:164.8},0).wait(1).to({scaleX:0.6827,scaleY:0.6827,x:211.8},0).wait(1).to({scaleX:0.6774,scaleY:0.6774,x:210.95},0).wait(1).to({scaleX:0.6718,scaleY:0.6718,x:210.05,y:164.75},0).wait(1).to({scaleX:0.6662,scaleY:0.6662,x:209.15,y:164.65},0).wait(1).to({scaleX:0.6606,scaleY:0.6606,x:208.2},0).wait(1).to({scaleX:0.6553,scaleY:0.6553,x:207.4},0).wait(1).to({scaleX:0.6504,scaleY:0.6504,x:206.6,y:164.6},0).wait(1).to({scaleX:0.646,scaleY:0.646,x:205.85,y:164.55},0).wait(1).to({scaleX:0.6421,scaleY:0.6421,x:205.2,y:164.5},0).wait(1).to({scaleX:0.6387,scaleY:0.6387,x:204.7,y:164.45},0).wait(1).to({scaleX:0.6359,scaleY:0.6359,x:204.25,y:164.5},0).wait(1).to({scaleX:0.6336,scaleY:0.6336,x:203.85},0).wait(1).to({scaleX:0.6317,scaleY:0.6317,x:203.55,y:164.45},0).wait(1).to({scaleX:0.6302,scaleY:0.6302,x:203.3},0).wait(1).to({scaleX:0.6292,scaleY:0.6292,x:203.15},0).wait(1).to({scaleX:0.6284,scaleY:0.6284,x:203},0).wait(1).to({scaleX:0.628,scaleY:0.628,x:202.95},0).wait(1).to({regX:0,regY:0,scaleX:0.6279,scaleY:0.6279,x:204.85,y:165.7},0).wait(103).to({regX:0.1,regY:0.1,x:204.9,y:165.75},0).wait(116).to({regX:-3,regY:-2,scaleX:0.628,scaleY:0.628,x:202.95,y:164.45},0).wait(1).to({scaleX:0.6284,scaleY:0.6284,x:203},0).wait(1).to({scaleX:0.629,scaleY:0.629,x:203.1,y:164.5},0).wait(1).to({scaleX:0.63,scaleY:0.63,x:203.2,y:164.55},0).wait(1).to({scaleX:0.6313,scaleY:0.6313,x:203.4,y:164.6},0).wait(1).to({scaleX:0.633,scaleY:0.633,x:203.65,y:164.7},0).wait(1).to({scaleX:0.6351,scaleY:0.6351,x:203.95,y:164.8},0).wait(1).to({scaleX:0.6376,scaleY:0.6376,x:204.3,y:164.85},0).wait(1).to({scaleX:0.6407,scaleY:0.6407,x:204.7,y:165},0).wait(1).to({scaleX:0.6441,scaleY:0.6441,x:205.15,y:165.2},0).wait(1).to({scaleX:0.6481,scaleY:0.6481,x:205.7,y:165.4},0).wait(1).to({scaleX:0.6524,scaleY:0.6524,x:206.3,y:165.6},0).wait(1).to({scaleX:0.6569,scaleY:0.6569,x:206.95,y:165.8},0).wait(1).to({scaleX:0.6616,scaleY:0.6616,x:207.55,y:166.05},0).wait(1).to({scaleX:0.6661,scaleY:0.6661,x:208.2,y:166.2},0).wait(1).to({scaleX:0.6704,scaleY:0.6704,x:208.8,y:166.45},0).wait(1).to({scaleX:0.6744,scaleY:0.6744,x:209.35,y:166.65},0).wait(1).to({scaleX:0.6779,scaleY:0.6779,x:209.75,y:166.8},0).wait(1).to({scaleX:0.6809,scaleY:0.6809,x:210.2,y:166.95},0).wait(1).to({scaleX:0.6834,scaleY:0.6834,x:210.55,y:167.1},0).wait(1).to({scaleX:0.6855,scaleY:0.6855,x:210.85,y:167.2},0).wait(1).to({scaleX:0.6872,scaleY:0.6872,x:211.1,y:167.25},0).wait(1).to({scaleX:0.6885,scaleY:0.6885,x:211.25,y:167.3},0).wait(1).to({scaleX:0.6895,scaleY:0.6895,x:211.4,y:167.35},0).wait(1).to({scaleX:0.6902,scaleY:0.6902,x:211.5},0).wait(1).to({scaleX:0.6905,scaleY:0.6905,x:211.55,y:167.4},0).wait(1).to({regX:0.1,regY:0.1,scaleX:0.6906,scaleY:0.6906,x:213.65,y:168.9},0).wait(87).to({alpha:0.0117},10,cjs.Ease.get(1)).to({_off:true},1).wait(446));

	// ch
	this.ch1 = new lib.character1_container();
	this.ch1.name = "ch1";
	this.ch1.parent = this;
	this.ch1.setTransform(-1346.7,570,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({scaleX:0.5255,scaleY:0.5255,x:139.6,y:255.4},0).wait(1).to({regX:-70,regY:-515.2,scaleX:0.5254,scaleY:0.5254,x:102.75,y:-15.3},0).wait(1).to({scaleX:0.5251,scaleY:0.5251,x:102.8,y:-15.2},0).wait(1).to({scaleX:0.5245,scaleY:0.5245,y:-15.05},0).wait(1).to({scaleX:0.5237,scaleY:0.5237,y:-14.75},0).wait(1).to({scaleX:0.5226,scaleY:0.5226,x:102.75,y:-14.4},0).wait(1).to({scaleX:0.5213,scaleY:0.5213,y:-13.95},0).wait(1).to({scaleX:0.5195,scaleY:0.5195,x:102.8,y:-13.35},0).wait(1).to({scaleX:0.5174,scaleY:0.5174,y:-12.7},0).wait(1).to({scaleX:0.515,scaleY:0.515,x:102.75,y:-11.85},0).wait(1).to({scaleX:0.5121,scaleY:0.5121,y:-10.85},0).wait(1).to({scaleX:0.5088,scaleY:0.5088,y:-9.8},0).wait(1).to({scaleX:0.5052,scaleY:0.5052,y:-8.55},0).wait(1).to({scaleX:0.5013,scaleY:0.5013,x:102.7,y:-7.25},0).wait(1).to({scaleX:0.4971,scaleY:0.4971,y:-5.85},0).wait(1).to({scaleX:0.4929,scaleY:0.4929,y:-4.5},0).wait(1).to({scaleX:0.4888,scaleY:0.4888,y:-3.15},0).wait(1).to({scaleX:0.4849,scaleY:0.4849,x:102.65,y:-1.8},0).wait(1).to({scaleX:0.4813,scaleY:0.4813,y:-0.6},0).wait(1).to({scaleX:0.478,scaleY:0.478,y:0.5},0).wait(1).to({scaleX:0.4751,scaleY:0.4751,y:1.45},0).wait(1).to({scaleX:0.4727,scaleY:0.4727,x:102.6,y:2.3},0).wait(1).to({scaleX:0.4706,scaleY:0.4706,y:2.95},0).wait(1).to({scaleX:0.4688,scaleY:0.4688,x:102.65,y:3.55},0).wait(1).to({scaleX:0.4674,scaleY:0.4674,y:4.05},0).wait(1).to({scaleX:0.4664,scaleY:0.4664,x:102.6,y:4.4},0).wait(1).to({scaleX:0.4656,scaleY:0.4656,y:4.65},0).wait(1).to({scaleX:0.465,scaleY:0.465,y:4.85},0).wait(1).to({scaleX:0.4647,scaleY:0.4647,y:4.95},0).wait(1).to({regX:0,regY:0,scaleX:0.4646,scaleY:0.4646,x:135.15,y:244.35},0).wait(219).to({regX:-70,regY:-515.2,scaleX:0.4647,scaleY:0.4647,x:102.6,y:4.95},0).wait(1).to({scaleX:0.465,scaleY:0.465,y:4.85},0).wait(1).to({scaleX:0.4654,scaleY:0.4654,x:102.55,y:4.75},0).wait(1).to({scaleX:0.4662,scaleY:0.4662,y:4.55},0).wait(1).to({scaleX:0.4671,scaleY:0.4671,x:102.5,y:4.3},0).wait(1).to({scaleX:0.4684,scaleY:0.4684,x:102.45,y:3.9},0).wait(1).to({scaleX:0.4699,scaleY:0.4699,y:3.5},0).wait(1).to({scaleX:0.4718,scaleY:0.4718,x:102.35,y:2.95},0).wait(1).to({scaleX:0.4741,scaleY:0.4741,x:102.3,y:2.35},0).wait(1).to({scaleX:0.4766,scaleY:0.4766,x:102.25,y:1.65},0).wait(1).to({scaleX:0.4796,scaleY:0.4796,x:102.15,y:0.85},0).wait(1).to({scaleX:0.4827,scaleY:0.4827,x:102.05,y:-0.05},0).wait(1).to({scaleX:0.4861,scaleY:0.4861,x:101.9,y:-1},0).wait(1).to({scaleX:0.4895,scaleY:0.4895,x:101.85,y:-1.95},0).wait(1).to({scaleX:0.4929,scaleY:0.4929,x:101.7,y:-2.9},0).wait(1).to({scaleX:0.4961,scaleY:0.4961,x:101.6,y:-3.8},0).wait(1).to({scaleX:0.499,scaleY:0.499,x:101.5,y:-4.6},0).wait(1).to({scaleX:0.5016,scaleY:0.5016,x:101.45,y:-5.25},0).wait(1).to({scaleX:0.5038,scaleY:0.5038,x:101.4,y:-5.9},0).wait(1).to({scaleX:0.5057,scaleY:0.5057,x:101.3,y:-6.45},0).wait(1).to({scaleX:0.5073,scaleY:0.5073,y:-6.85},0).wait(1).to({scaleX:0.5085,scaleY:0.5085,x:101.25,y:-7.25},0).wait(1).to({scaleX:0.5095,scaleY:0.5095,x:101.2,y:-7.5},0).wait(1).to({scaleX:0.5102,scaleY:0.5102,y:-7.7},0).wait(1).to({scaleX:0.5107,scaleY:0.5107,x:101.15,y:-7.8},0).wait(1).to({scaleX:0.511,scaleY:0.511,y:-7.9},0).wait(1).to({regX:0,regY:0.1,x:136.95,y:255.4},0).wait(87).to({alpha:0.0117},10,cjs.Ease.get(1)).to({_off:true},1).wait(446));

	// bg
	this.bg1 = new lib.bg_zoom_half();
	this.bg1.name = "bg1";
	this.bg1.parent = this;
	this.bg1.setTransform(-1170.65,-279.15,1.27,1.27);

	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({scaleX:0.5255,scaleY:0.5255,x:-45.7,y:-32.45},0).wait(1).to({regX:278.7,regY:353,scaleX:0.5254,scaleY:0.5254,x:100.75,y:153.05},0).wait(1).to({scaleX:0.5251,scaleY:0.5251,x:100.8},0).wait(1).to({scaleX:0.5245,scaleY:0.5245},0).wait(1).to({scaleX:0.5237,scaleY:0.5237,x:100.75},0).wait(1).to({scaleX:0.5226,scaleY:0.5226,y:153.1},0).wait(1).to({scaleX:0.5213,scaleY:0.5213},0).wait(1).to({scaleX:0.5195,scaleY:0.5195,x:100.8,y:153.15},0).wait(1).to({scaleX:0.5174,scaleY:0.5174,x:100.75},0).wait(1).to({scaleX:0.515,scaleY:0.515,y:153.2},0).wait(1).to({scaleX:0.5121,scaleY:0.5121},0).wait(1).to({scaleX:0.5088,scaleY:0.5088,y:153.25},0).wait(1).to({scaleX:0.5052,scaleY:0.5052,x:100.8,y:153.35},0).wait(1).to({scaleX:0.5013,scaleY:0.5013,x:100.75},0).wait(1).to({scaleX:0.4971,scaleY:0.4971,y:153.4},0).wait(1).to({scaleX:0.4929,scaleY:0.4929,x:100.8,y:153.45},0).wait(1).to({scaleX:0.4888,scaleY:0.4888,y:153.5},0).wait(1).to({scaleX:0.4849,scaleY:0.4849,x:100.75},0).wait(1).to({scaleX:0.4813,scaleY:0.4813,x:100.8,y:153.6},0).wait(1).to({scaleX:0.478,scaleY:0.478,x:100.75,y:153.65},0).wait(1).to({scaleX:0.4751,scaleY:0.4751},0).wait(1).to({scaleX:0.4727,scaleY:0.4727,x:100.8,y:153.7},0).wait(1).to({scaleX:0.4706,scaleY:0.4706,x:100.75},0).wait(1).to({scaleX:0.4688,scaleY:0.4688,y:153.75},0).wait(1).to({scaleX:0.4674,scaleY:0.4674},0).wait(1).to({scaleX:0.4664,scaleY:0.4664},0).wait(1).to({scaleX:0.4656,scaleY:0.4656,y:153.8},0).wait(1).to({scaleX:0.465,scaleY:0.465},0).wait(1).to({scaleX:0.4647,scaleY:0.4647},0).wait(1).to({regX:0,regY:0,scaleX:0.4646,scaleY:0.4646,x:-28.75,y:-10.25},0).wait(103).to({regX:-0.1,regY:-0.1,x:-28.8,y:-10.3},0).wait(116).to({regX:278.7,regY:353,scaleX:0.4647,scaleY:0.4647,x:100.75,y:153.8},0).wait(1).to({scaleX:0.465,scaleY:0.465},0).wait(1).to({scaleX:0.4654,scaleY:0.4654,x:100.7},0).wait(1).to({scaleX:0.4662,scaleY:0.4662,y:153.85},0).wait(1).to({scaleX:0.4671,scaleY:0.4671,y:153.9},0).wait(1).to({scaleX:0.4684,scaleY:0.4684,x:100.65,y:153.95},0).wait(1).to({scaleX:0.4699,scaleY:0.4699,x:100.55,y:154},0).wait(1).to({scaleX:0.4718,scaleY:0.4718,x:100.5,y:154.1},0).wait(1).to({scaleX:0.4741,scaleY:0.4741,x:100.4,y:154.2},0).wait(1).to({scaleX:0.4766,scaleY:0.4766,x:100.35,y:154.3},0).wait(1).to({scaleX:0.4796,scaleY:0.4796,x:100.2,y:154.4},0).wait(1).to({scaleX:0.4827,scaleY:0.4827,x:100.1,y:154.55},0).wait(1).to({scaleX:0.4861,scaleY:0.4861,x:100,y:154.7},0).wait(1).to({scaleX:0.4895,scaleY:0.4895,x:99.9,y:154.8},0).wait(1).to({scaleX:0.4929,scaleY:0.4929,x:99.75,y:154.95},0).wait(1).to({scaleX:0.4961,scaleY:0.4961,x:99.6,y:155.1},0).wait(1).to({scaleX:0.499,scaleY:0.499,x:99.5,y:155.2},0).wait(1).to({scaleX:0.5016,scaleY:0.5016,x:99.45,y:155.3},0).wait(1).to({scaleX:0.5038,scaleY:0.5038,x:99.35,y:155.4},0).wait(1).to({scaleX:0.5057,scaleY:0.5057,x:99.3,y:155.5},0).wait(1).to({scaleX:0.5073,scaleY:0.5073,x:99.2,y:155.55},0).wait(1).to({scaleX:0.5085,scaleY:0.5085,x:99.15,y:155.6},0).wait(1).to({scaleX:0.5095,scaleY:0.5095,y:155.65},0).wait(1).to({scaleX:0.5102,scaleY:0.5102,y:155.7},0).wait(1).to({scaleX:0.5107,scaleY:0.5107},0).wait(1).to({scaleX:0.511,scaleY:0.511,x:99.1},0).wait(1).to({regX:-0.2,regY:-0.2,x:-43.4,y:-24.75},0).wait(87).to({alpha:0.0117},10,cjs.Ease.get(1)).to({_off:true},1).wait(446));

	// ch4
	this.ch4 = new lib.ch3_anim();
	this.ch4.name = "ch4";
	this.ch4.parent = this;
	this.ch4.setTransform(1048.8,165.75,0.6279,0.6279,0,0,0,0.1,0.1);
	this.ch4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.ch4).wait(147).to({_off:false},0).wait(229).to({scaleX:0.7785,scaleY:0.7785,x:229.05,y:160.7},0).wait(1).to({regX:-3,regY:-2,x:226.6,y:159.1},0).wait(1).to({y:159.35},0).wait(1).to({y:159.75},0).wait(1).to({y:160.4},0).wait(1).to({y:161.35},0).wait(1).to({y:162.5},0).wait(1).to({y:163.8},0).wait(1).to({y:164.95},0).wait(1).to({y:165.9},0).wait(1).to({y:166.55},0).wait(1).to({y:166.95},0).wait(1).to({y:167.2},0).wait(1).to({regX:0.1,regY:0.1,x:229.05,y:168.95},0).wait(120).to({regX:-3,regY:-2,scaleX:0.7787,scaleY:0.7787,x:226.6,y:167.3},0).wait(1).to({scaleX:0.7793,scaleY:0.7793,x:226.65},0).wait(1).to({scaleX:0.7802,scaleY:0.7802,x:226.8,y:167.4},0).wait(1).to({scaleX:0.7815,scaleY:0.7815,x:227,y:167.5},0).wait(1).to({scaleX:0.7833,scaleY:0.7833,x:227.25,y:167.6},0).wait(1).to({scaleX:0.7856,scaleY:0.7856,x:227.55,y:167.75},0).wait(1).to({scaleX:0.7885,scaleY:0.7885,x:227.95,y:167.9},0).wait(1).to({scaleX:0.792,scaleY:0.792,x:228.4,y:168.15},0).wait(1).to({scaleX:0.796,scaleY:0.796,x:228.95,y:168.4},0).wait(1).to({scaleX:0.8008,scaleY:0.8008,x:229.6,y:168.75},0).wait(1).to({scaleX:0.8062,scaleY:0.8062,x:230.35,y:169.1},0).wait(1).to({scaleX:0.8123,scaleY:0.8123,x:231.15,y:169.55},0).wait(1).to({scaleX:0.819,scaleY:0.819,x:232.1,y:169.95},0).wait(1).to({scaleX:0.8263,scaleY:0.8263,x:233.1,y:170.45},0).wait(1).to({scaleX:0.8341,scaleY:0.8341,x:234.15,y:171},0).wait(1).to({scaleX:0.8422,scaleY:0.8422,x:235.25,y:171.5},0).wait(1).to({scaleX:0.8505,scaleY:0.8505,x:236.4,y:172.05},0).wait(1).to({scaleX:0.8586,scaleY:0.8586,x:237.45,y:172.6},0).wait(1).to({scaleX:0.8664,scaleY:0.8664,x:238.55,y:173.1},0).wait(1).to({scaleX:0.8737,scaleY:0.8737,x:239.6,y:173.6},0).wait(1).to({scaleX:0.8804,scaleY:0.8804,x:240.45,y:174.05},0).wait(1).to({scaleX:0.8865,scaleY:0.8865,x:241.3,y:174.5},0).wait(1).to({scaleX:0.892,scaleY:0.892,x:242.05,y:174.8},0).wait(1).to({scaleX:0.8967,scaleY:0.8967,x:242.7,y:175.15},0).wait(1).to({scaleX:0.9008,scaleY:0.9008,x:243.25,y:175.4},0).wait(1).to({scaleX:0.9042,scaleY:0.9042,x:243.75,y:175.65},0).wait(1).to({scaleX:0.9071,scaleY:0.9071,x:244.15,y:175.85},0).wait(1).to({scaleX:0.9094,scaleY:0.9094,x:244.4,y:176},0).wait(1).to({scaleX:0.9112,scaleY:0.9112,x:244.65,y:176.15},0).wait(1).to({scaleX:0.9125,scaleY:0.9125,x:244.85},0).wait(1).to({scaleX:0.9135,scaleY:0.9135,x:244.95,y:176.25},0).wait(1).to({scaleX:0.914,scaleY:0.914,x:245.05},0).wait(1).to({regX:0.1,regY:0.1,scaleX:0.9142,scaleY:0.9142,x:247.9,y:178.3},0).wait(164).to({regX:0.3,regY:0.4,scaleX:0.6173,scaleY:0.6173,x:204,y:164.7},0).wait(128));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(979.05,244.35,0.4646,0.4646);
	this.ch2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(147).to({_off:false},0).wait(229).to({regX:0.1,regY:0.1,scaleX:0.5761,scaleY:0.5761,x:142.55,y:258.15},0).wait(1).to({regX:-70,regY:-515.2,x:102.15,y:-38.65},0).wait(1).to({y:-38.4},0).wait(1).to({y:-38},0).wait(1).to({y:-37.35},0).wait(1).to({y:-36.4},0).wait(1).to({y:-35.25},0).wait(1).to({y:-33.95},0).wait(1).to({y:-32.8},0).wait(1).to({y:-31.85},0).wait(1).to({y:-31.2},0).wait(1).to({y:-30.8},0).wait(1).to({y:-30.55},0).wait(1).to({regX:0.1,regY:0.1,x:142.55,y:266.4},0).wait(120).to({regX:-70,regY:-515.2,scaleX:0.5762,scaleY:0.5762,x:102.15,y:-30.5},0).wait(1).to({scaleX:0.5766,scaleY:0.5766,y:-30.6},0).wait(1).to({scaleX:0.5773,scaleY:0.5773,x:102.1,y:-30.75},0).wait(1).to({scaleX:0.5783,scaleY:0.5783,x:102.05,y:-31.05},0).wait(1).to({scaleX:0.5796,scaleY:0.5796,y:-31.4},0).wait(1).to({scaleX:0.5813,scaleY:0.5813,x:102,y:-31.8},0).wait(1).to({scaleX:0.5835,scaleY:0.5835,x:101.9,y:-32.35},0).wait(1).to({scaleX:0.586,scaleY:0.586,x:101.85,y:-32.95},0).wait(1).to({scaleX:0.589,scaleY:0.589,x:101.7,y:-33.75},0).wait(1).to({scaleX:0.5925,scaleY:0.5925,x:101.6,y:-34.6},0).wait(1).to({scaleX:0.5965,scaleY:0.5965,x:101.5,y:-35.65},0).wait(1).to({scaleX:0.601,scaleY:0.601,x:101.4,y:-36.75},0).wait(1).to({scaleX:0.606,scaleY:0.606,x:101.25,y:-38.05},0).wait(1).to({scaleX:0.6115,scaleY:0.6115,x:101.05,y:-39.4},0).wait(1).to({scaleX:0.6172,scaleY:0.6172,x:100.85,y:-40.85},0).wait(1).to({scaleX:0.6232,scaleY:0.6232,x:100.65,y:-42.4},0).wait(1).to({scaleX:0.6293,scaleY:0.6293,x:100.5,y:-43.9},0).wait(1).to({scaleX:0.6353,scaleY:0.6353,x:100.3,y:-45.4},0).wait(1).to({scaleX:0.6411,scaleY:0.6411,x:100.15,y:-46.9},0).wait(1).to({scaleX:0.6465,scaleY:0.6465,x:99.95,y:-48.2},0).wait(1).to({scaleX:0.6515,scaleY:0.6515,x:99.8,y:-49.5},0).wait(1).to({scaleX:0.656,scaleY:0.656,x:99.65,y:-50.65},0).wait(1).to({scaleX:0.66,scaleY:0.66,x:99.5,y:-51.65},0).wait(1).to({scaleX:0.6635,scaleY:0.6635,x:99.4,y:-52.55},0).wait(1).to({scaleX:0.6665,scaleY:0.6665,x:99.3,y:-53.3},0).wait(1).to({scaleX:0.6691,scaleY:0.6691,x:99.2,y:-53.95},0).wait(1).to({scaleX:0.6712,scaleY:0.6712,x:99.15,y:-54.5},0).wait(1).to({scaleX:0.6729,scaleY:0.6729,x:99.1,y:-54.9},0).wait(1).to({scaleX:0.6742,scaleY:0.6742,x:99.05,y:-55.25},0).wait(1).to({scaleX:0.6752,scaleY:0.6752,y:-55.5},0).wait(1).to({scaleX:0.6759,scaleY:0.6759,x:99,y:-55.7},0).wait(1).to({scaleX:0.6763,scaleY:0.6763,y:-55.8},0).wait(1).to({regX:0.2,regY:0.2,scaleX:0.6764,scaleY:0.6764,x:146.45,y:292.8},0).wait(164).to({regX:0.6,regY:0.4,scaleX:0.4568,scaleY:0.4568,x:135.5,y:242},0).wait(128));

	// bg
	this.bg1_1 = new lib.bg_zoom_half();
	this.bg1_1.name = "bg1_1";
	this.bg1_1.parent = this;
	this.bg1_1.setTransform(815.1,-10.3,0.4646,0.4646,0,0,0,-0.1,-0.1);
	this.bg1_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg1_1).wait(147).to({_off:false},0).wait(229).to({scaleX:0.5761,scaleY:0.5761,x:-60.75,y:-57.6},0).wait(1).to({regX:278.7,regY:353,x:99.85,y:145.9},0).wait(1).to({y:146.15},0).wait(1).to({y:146.55},0).wait(1).to({y:147.2},0).wait(1).to({y:148.15},0).wait(1).to({y:149.3},0).wait(1).to({y:150.6},0).wait(1).to({y:151.75},0).wait(1).to({y:152.7},0).wait(1).to({y:153.35},0).wait(1).to({y:153.75},0).wait(1).to({y:154},0).wait(1).to({regX:-0.1,regY:-0.1,x:-60.75,y:-49.35},0).wait(120).to({regX:278.7,regY:353,scaleX:0.5762,scaleY:0.5762,x:99.9,y:154.1},0).wait(1).to({scaleX:0.5766,scaleY:0.5766,x:99.85,y:154.15},0).wait(1).to({scaleX:0.5773,scaleY:0.5773,y:154.2},0).wait(1).to({scaleX:0.5783,scaleY:0.5783,x:99.8,y:154.25},0).wait(1).to({scaleX:0.5796,scaleY:0.5796,x:99.75,y:154.3},0).wait(1).to({scaleX:0.5813,scaleY:0.5813,x:99.65,y:154.45},0).wait(1).to({scaleX:0.5835,scaleY:0.5835,x:99.6,y:154.55},0).wait(1).to({scaleX:0.586,scaleY:0.586,x:99.5,y:154.75},0).wait(1).to({scaleX:0.589,scaleY:0.589,x:99.4,y:154.95},0).wait(1).to({scaleX:0.5925,scaleY:0.5925,x:99.3,y:155.2},0).wait(1).to({scaleX:0.5965,scaleY:0.5965,x:99.15,y:155.45},0).wait(1).to({scaleX:0.601,scaleY:0.601,x:99,y:155.75},0).wait(1).to({scaleX:0.606,scaleY:0.606,x:98.8,y:156.15},0).wait(1).to({scaleX:0.6115,scaleY:0.6115,x:98.6,y:156.5},0).wait(1).to({scaleX:0.6172,scaleY:0.6172,x:98.4,y:156.9},0).wait(1).to({scaleX:0.6232,scaleY:0.6232,x:98.2,y:157.3},0).wait(1).to({scaleX:0.6293,scaleY:0.6293,x:98,y:157.7},0).wait(1).to({scaleX:0.6353,scaleY:0.6353,x:97.75,y:158.1},0).wait(1).to({scaleX:0.6411,scaleY:0.6411,x:97.55,y:158.5},0).wait(1).to({scaleX:0.6465,scaleY:0.6465,x:97.4,y:158.85},0).wait(1).to({scaleX:0.6515,scaleY:0.6515,x:97.2,y:159.2},0).wait(1).to({scaleX:0.656,scaleY:0.656,x:97,y:159.5},0).wait(1).to({scaleX:0.66,scaleY:0.66,x:96.9,y:159.8},0).wait(1).to({scaleX:0.6635,scaleY:0.6635,x:96.75,y:160},0).wait(1).to({scaleX:0.6665,scaleY:0.6665,x:96.65,y:160.25},0).wait(1).to({scaleX:0.6691,scaleY:0.6691,x:96.55,y:160.4},0).wait(1).to({scaleX:0.6712,scaleY:0.6712,x:96.5,y:160.5},0).wait(1).to({scaleX:0.6729,scaleY:0.6729,x:96.45,y:160.65},0).wait(1).to({scaleX:0.6742,scaleY:0.6742,x:96.4,y:160.75},0).wait(1).to({scaleX:0.6752,scaleY:0.6752,x:96.35,y:160.8},0).wait(1).to({scaleX:0.6759,scaleY:0.6759,x:96.3,y:160.85},0).wait(1).to({scaleX:0.6763,scaleY:0.6763,x:96.35,y:160.9},0).wait(1).to({regX:-0.1,regY:-0.2,scaleX:0.6764,scaleY:0.6764,x:-92.25,y:-78},0).wait(164).to({regX:-0.5,regY:-0.5,scaleX:0.4568,scaleY:0.4568,x:-25.8,y:-8.55},0).wait(128));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},761).wait(72));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},773).wait(55).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1435.2,-720,2550.8,1366);
// library properties:
lib.properties = {
	id: '_429_2',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1606285464267", id:"_429_2_bg"},
		{src:"images/book1.png?1606285464267", id:"_429_2_book1"},
		{src:"images/book2.png?1606285464267", id:"_429_2_book2"},
		{src:"images/ch_base.png?1606285464267", id:"_429_2_ch_base"},
		{src:"images/ch_face13.png?1606285464267", id:"_429_2_ch_face13"},
		{src:"images/ch_face2.png?1606285464267", id:"_429_2_ch_face2"},
		{src:"images/ch_face3.png?1606285464267", id:"_429_2_ch_face3"},
		{src:"images/ch_face4.png?1606285464267", id:"_429_2_ch_face4"},
		{src:"images/ch_face5.png?1606285464267", id:"_429_2_ch_face5"},
		{src:"images/ch_face6.png?1606285464267", id:"_429_2_ch_face6"},
		{src:"images/ch_face7.png?1606285464267", id:"_429_2_ch_face7"},
		{src:"images/finish.jpg?1606285464267", id:"_429_2_finish"},
		{src:"images/finish_blur.jpg?1606285464267", id:"_429_2_finish_blur"},
		{src:"images/sun_light.png?1606285464267", id:"_429_2_sun_light"},
		{src:"images/tie_fp.png?1606285464267", id:"_429_2_tie_fp"},
		{src:"images/tie_sp.png?1606285464267", id:"_429_2_tie_sp"}
	],
	preloads: []
};
