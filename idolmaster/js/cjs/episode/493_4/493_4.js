...
(lib.bg = function() {
	this.initialize(img._493_4_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1200,1400);


(lib.ch_base = function() {
	this.initialize(img._493_4_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1200,1400);


(lib.ch_face10 = function() {
	this.initialize(img._493_4_ch_face10);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face11 = function() {
	this.initialize(img._493_4_ch_face11);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face12 = function() {
	this.initialize(img._493_4_ch_face12);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face2 = function() {
	this.initialize(img._493_4_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face3 = function() {
	this.initialize(img._493_4_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face4 = function() {
	this.initialize(img._493_4_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face5 = function() {
	this.initialize(img._493_4_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face6 = function() {
	this.initialize(img._493_4_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face7 = function() {
	this.initialize(img._493_4_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face8 = function() {
	this.initialize(img._493_4_ch_face8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.ch_face9 = function() {
	this.initialize(img._493_4_ch_face9);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,260,260);


(lib.finish = function() {
	this.initialize(img._493_4_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._493_4_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.tie_fp = function() {
	this.initialize(img._493_4_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._493_4_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
(lib.tie = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(48.025,0.65);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("");
	this.shape_1.setTransform(32,0.375);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("AhAAvQAbgEAUgJQASgHANgNQAOgMAJgQQAJgRAEgVIARAKIgIAXQgFANgHAMQgJAMgMAMQgNAKgTAKQgUAJgbAFgAgigeIgRgLIgPgIIANgOIAKAGIAMAHIANAJIAMAJIgOAPQgFgGgJgHg");
	this.shape_2.setTransform(16.4,0.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("AAEA7IABg9QgMAIgMAFIgZAKIgMgOQAggIAYgQQAZgRAQgYIAQAIIgSAUIgSARIAAAPIAAATIAAAUIAAASg");
	this.shape_3.setTransform(-0.4,1.9);
	...
	this.shape_6.setTransform(-48.075,0.775);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("Ap7FEIAPiIIBkkRICRhjIC2AWIBuAoIClgrIAih+IBGhIIBTgbICWAVICEBGIBVBzIgFBhIioBaIh8AoIleBIIiGBWIiRBTIj5Brg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:67.4,y:60.275}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
...
p.nominalBounds = new cjs.Rectangle(-210,-200,600,700);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.f.name = "f";
	this.f.parent = this;
	this.f.setTransform(-171.65,-581.15);
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-261.65,-385.15);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-381.6,-781.1,691.8,912.8);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(22.85,-367.85,1.1857,1.1857,169.9438,0,0,-29.1,20.5);
	this.instance_4._off = true;

	this.instance_5 = new lib.laugh("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(38.85,-364.3,1.4181,1.4181,0,-35.8376,144.173,-30.2,20.5);
	this.instance_5._off = true;

	this.instance_6 = new lib.chord("synched",0,false);
	this.instance_6.parent = this;
	this.instance_6.setTransform(15.75,-281.9,1.0026,1.0026,-6.2632,0,0,-23.4,76.9);

	this.instance_7 = new lib.question();
	this.instance_7.parent = this;
	this.instance_7.setTransform(11.05,-364.8,1.053,1.053,29.448);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.instance_8 = new lib.mc_exclamation("synched",0,false);
	this.instance_8.parent = this;
	this.instance_8.setTransform(14.8,-380.2,1.0929,1.0929,0,30,-150.0007,-0.1,0.1);

	this.instance_9 = new lib.drop1a("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(10.5,-362.7,1,1,0,0,0,-0.5,0.2);
	this.instance_9._off = true;

	this.instance_10 = new lib.drop2_v2("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(9.1,-362.55,0.9876,0.9876,0,-14.9998,165.0002);
	this.instance_10._off = true;

	this.instance_11 = new lib.shock("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(15.55,-365.55,1.3878,1.3878,0,121.2396,-58.7604);

	this.instance_12 = new lib.sigh("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(-10.9,-212.25,1,1,0,0,180);
	this.instance_12.alpha = 0.6016;
	this.instance_12._off = true;

	this.instance_13 = new lib.heart("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(15.75,-321.7,0.4532,0.4532,0,0,180);
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:-81.6,regY:-431.2,x:-81.6,y:-439.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-440.4},0).wait(1).to({y:-437.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-436.7},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-436.95},0).wait(1).to({y:-430},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-427.95},0).wait(1).to({y:-430.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-436.15},0).wait(1).to({y:-430.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-436.15},0).wait(1).to({y:-430.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-430.3},0).wait(1).to({y:-430.95},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-440.2},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-444.15},0).wait(1).to({y:-440.55},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-429.2},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-431.45},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-440.2},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-444.15},0).wait(1).to({y:-440.55},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-429.2},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-431.45},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-81.6,regY:-431.2,x:-81.6,y:-430.6},0).wait(1).to({y:-428.2},0).wait(1).to({y:-425.85},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-425.85},0).wait(1).to({y:-428.2},0).wait(1).to({y:-430.6},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-81.6,regY:-431.2,x:-81.6,y:-431.05},0).wait(1).to({y:-430.5},0).wait(1).to({y:-429.4},0).wait(1).to({y:-428.05},0).wait(1).to({y:-426.95},0).wait(1).to({y:-426.4},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-426.4},0).wait(1).to({y:-426.95},0).wait(1).to({y:-428.05},0).wait(1).to({y:-429.4},0).wait(1).to({y:-430.5},0).wait(1).to({y:-431.05},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-426.45},0).wait(1).to({y:-430},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-429},0).wait(1).to({y:-430.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-81.6,regY:-431.2,rotation:0.0244,x:-81.4,y:-431.2},0).wait(1).to({rotation:0.1092,x:-80.7,y:-431},0).wait(1).to({rotation:0.275,x:-79.2,y:-430.7},0).wait(1).to({rotation:0.538,x:-76.85,y:-430.15},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:-73.9,y:-429.5},0).wait(1).to({rotation:1.1673,x:-71.25,y:-428.85},0).wait(1).to({rotation:1.367,x:-69.45,y:-428.45},0).wait(1).to({rotation:1.4695,x:-68.55,y:-428.2},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:-81.6,regY:-431.2,rotation:1.4793,x:-68.5,y:-428.25},0).wait(1).to({rotation:1.4124,x:-69.1,y:-428.35},0).wait(1).to({rotation:1.2834,x:-70.25,y:-428.7},0).wait(1).to({rotation:1.0775,x:-72.15,y:-429.15},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.7991,x:-74.6,y:-429.7},0).wait(1).to({rotation:0.5016,x:-77.25,y:-430.25},0).wait(1).to({rotation:0.2603,x:-79.4,y:-430.75},0).wait(1).to({rotation:0.1043,x:-80.75,y:-431.1},0).wait(1).to({rotation:0.0235,x:-81.45,y:-431.25},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(2).to({regX:-81.6,regY:-431.2,rotation:0.0244,x:-81.4,y:-431.2},0).wait(1).to({rotation:0.1092,x:-80.7,y:-431},0).wait(1).to({rotation:0.275,x:-79.2,y:-430.7},0).wait(1).to({rotation:0.538,x:-76.85,y:-430.15},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:-73.9,y:-429.5},0).wait(1).to({rotation:1.1673,x:-71.25,y:-428.85},0).wait(1).to({rotation:1.367,x:-69.45,y:-428.45},0).wait(1).to({rotation:1.4695,x:-68.55,y:-428.2},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:-81.6,regY:-431.2,rotation:1.4793,x:-68.5,y:-428.25},0).wait(1).to({rotation:1.4124,x:-69.1,y:-428.35},0).wait(1).to({rotation:1.2834,x:-70.25,y:-428.7},0).wait(1).to({rotation:1.0775,x:-72.15,y:-429.15},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.7991,x:-74.6,y:-429.7},0).wait(1).to({rotation:0.5016,x:-77.25,y:-430.25},0).wait(1).to({rotation:0.2603,x:-79.4,y:-430.75},0).wait(1).to({rotation:0.1043,x:-80.75,y:-431.1},0).wait(1).to({rotation:0.0235,x:-81.45,y:-431.25},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:-81.6,regY:-431.2,x:-81.6,y:-436.75},0).wait(1).to({y:-438.65},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-438.55},0).wait(1).to({y:-436.45},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:-81.6,regY:-431.2,x:-81.6,y:-439.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-440.4},0).wait(1).to({y:-437.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:-81.6,regY:-431.2,rotation:-0.0253,x:-81.8,y:-431.05},0).wait(1).to({rotation:-0.1129,x:-82.35,y:-430.4},0).wait(1).to({rotation:-0.2845,x:-83.4,y:-429.15},0).wait(1).to({rotation:-0.5565,x:-85.1,y:-427.15},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-87.2,y:-424.6},0).wait(1).to({rotation:-1.2075,x:-89.1,y:-422.35},0).wait(1).to({rotation:-1.4141,x:-90.4,y:-420.8},0).wait(1).to({rotation:-1.5201,x:-91.05,y:-420.05},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:9},0).wait(1).to({regX:-81.6,regY:-431.2,rotation:-1.5305,x:-91.1,y:-419.95},0).wait(1).to({rotation:-1.4624,x:-90.7,y:-420.45},0).wait(1).to({rotation:-1.3309,x:-89.85,y:-421.45},0).wait(1).to({rotation:-1.121,x:-88.65,y:-423},0).wait(1).to({rotation:-0.8372,x:-86.85,y:-425.15},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:-84.95,y:-427.4},0).wait(1).to({rotation:-0.2881,x:-83.45,y:-429.2},0).wait(1).to({rotation:-0.1291,x:-82.45,y:-430.4},0).wait(1).to({rotation:-0.0467,x:-81.95,y:-431.05},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-81.6,regY:-431.2,rotation:0.1421,x:-80.4,y:-430.95},0).wait(1).to({rotation:0.6998,x:-75.45,y:-429.85},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.327,x:-69.8,y:-428.55},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(18).to({regX:-81.6,regY:-431.2,rotation:1.4399,x:-68.85,y:-428.3},0).wait(1).to({rotation:1.2196,x:-70.85,y:-428.8},0).wait(1).to({rotation:0.7884,x:-74.65,y:-429.65},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:-78.9,y:-430.55},0).wait(1).to({rotation:0.0482,x:-81.25,y:-431.1},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-81.6,regY:-431.2,rotation:0.0865,x:-80.85,y:-431.05},0).wait(1).to({rotation:0.4213,x:-77.9,y:-430.35},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.9973,x:-72.8,y:-429.2},0).wait(1).to({rotation:1.3945,x:-69.2,y:-428.4},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(8).to({regX:-81.6,regY:-431.2,rotation:1.4399,x:-68.85,y:-428.3},0).wait(1).to({rotation:1.2196,x:-70.85,y:-428.8},0).wait(1).to({rotation:0.7884,x:-74.65,y:-429.65},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:-78.9,y:-430.55},0).wait(1).to({rotation:0.0482,x:-81.25,y:-431.1},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-439.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-440.4},0).wait(1).to({y:-437.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-81.6,regY:-431.2,x:-84.35,y:-423.45},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:-81.6,regY:-431.2,x:-81.6,y:-418.95},0).wait(1).to({y:-421.9},0).wait(1).to({y:-426.85},0).wait(1).to({y:-430.3},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-430.2},0).wait(1).to({y:-424.25},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:-81.6,regY:-431.2,x:-81.6,y:-423.4},0).wait(1).to({y:-427.7},0).wait(1).to({y:-432},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-431.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-81.6,regY:-431.2,x:-81.6,y:-437.9},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-438.05},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-439.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-440.4},0).wait(1).to({y:-437.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-81.6,regY:-431.2,x:-84.35,y:-423.45},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:-81.6,regY:-431.2,x:-81.6,y:-420.45},0).wait(1).to({y:-428.2},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-432.2},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-431.35},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-430.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-81.6,regY:-431.2,x:-81.6,y:-430.6},0).wait(1).to({y:-428.2},0).wait(1).to({y:-425.85},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-425.8},0).wait(1).to({y:-426.1},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:-81.6,regY:-431.2,x:-81.6,y:-426.6},0).wait(1).to({y:-428.1},0).wait(1).to({y:-430.35},0).wait(1).to({y:-431.8},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-431.45},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-438.8},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-440.4},0).wait(1).to({y:-437.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:-81.6,regY:-431.2,x:-81.6,y:-438.7},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:-81.6,regY:-431.2,x:-81.6,y:-439.2},0).wait(1).to({y:-433.2},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:-81.6,regY:-431.2,x:-81.6,y:-426.55},0).wait(1).to({y:-427.75},0).wait(1).to({y:-429.7},0).wait(1).to({y:-430.9},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-436.15},0).wait(1).to({y:-430.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-436.15},0).wait(1).to({y:-430.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-81.6,regY:-431.2,x:-81.6,y:-430.3},0).wait(1).to({y:-430.95},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-81.6,regY:-431.2,x:-78.6,y:-427.8},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:-81.6,regY:-431.2,x:-82.45,y:-421.75},0).wait(1).to({x:-81.8,y:-421.35},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:-81.6,regY:-431.2,x:-81.6,y:-421.9},0).wait(1).to({y:-424.35},0).wait(1).to({y:-428.05},0).wait(1).to({y:-430.55},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(10));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-456.9,-795.1,813.5,927.6);
...
// stage content:
(lib._493_4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:144,scene2:145,end2:286,scene3:287,end3:411,scene4:412,end4:545,scene5:546,end5:667,scene6:668,end6:799,scene7:800,end7:931});
	...
	this.frame_45 = function() {
		...
		exportRoot._g.m3 = "登場だよ! ";
		exportRoot._u.setText();
	}
	this.frame_90 = function() {
		exportRoot._g.m3 = "登場だよ! えへへ､";
		exportRoot._u.setText();
	...
	this.frame_474 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "は今と同じかな? ";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 7);
	}
	this.frame_502 = function() {
		exportRoot._g.m3 = "は今と同じかな? ほら､";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 2);
	}
	...
	this.frame_554 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "さんあるよ! ";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 8);
	}
	this.frame_588 = function() {
		exportRoot._g.m2 = "さんあるよ! みりあ､";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 1);
	}
	this.frame_598 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "なったでしょ? ";
		exportRoot._u.setText();
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(29).call(this.frame_44).wait(1).call(this.frame_45).wait(45).call(this.frame_90).wait(16).call(this.frame_106).wait(13).call(this.frame_119).wait(25).call(this.frame_144).wait(1).call(this.frame_145).wait(9).call(this.frame_154).wait(29).call(this.frame_183).wait(35).call(this.frame_218).wait(41).call(this.frame_259).wait(27).call(this.frame_286).wait(1).call(this.frame_287).wait(41).call(this.frame_328).wait(29).call(this.frame_357).wait(28).call(this.frame_385).wait(26).call(this.frame_411).wait(1).call(this.frame_412).wait(5).call(this.frame_417).wait(21).call(this.frame_438).wait(34).call(this.frame_472).wait(2).call(this.frame_474).wait(28).call(this.frame_502).wait(10).call(this.frame_512).wait(33).call(this.frame_545).wait(1).call(this.frame_546).wait(8).call(this.frame_554).wait(34).call(this.frame_588).wait(10).call(this.frame_598).wait(26).call(this.frame_624).wait(24).call(this.frame_648).wait(19).call(this.frame_667).wait(1).call(this.frame_668).wait(6).call(this.frame_674).wait(32).call(this.frame_706).wait(17).call(this.frame_723).wait(15).call(this.frame_738).wait(23).call(this.frame_761).wait(15).call(this.frame_776).wait(23).call(this.frame_799).wait(1).call(this.frame_800).wait(10).call(this.frame_810).wait(38).call(this.frame_848).wait(24).call(this.frame_872).wait(32).call(this.frame_904).wait(27).call(this.frame_931).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(936));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(931).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(936));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(917));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(921));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({alpha:0.1016},3).to({_off:true},1).wait(930));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(859).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(37));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_2).wait(899).to({_off:false},0).wait(1).to({regX:3.5,regY:59.1,x:123.5,y:380.6},0).wait(1).to({y:378.9},0).wait(1).to({y:375.6},0).wait(1).to({y:370.25},0).wait(1).to({y:362.8},0).wait(1).to({y:354.45},0).wait(1).to({y:347.5},0).wait(1).to({y:342.95},0).wait(1).to({y:340.65},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(24));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},899).wait(37));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(899).to({_off:false},0).wait(37));
	...
	this.timeline.addTween(cjs.Tween.get(this.ranko_finish_blur).wait(899).to({_off:false},0).wait(1).to({regX:120,regY:155,x:120,y:155,alpha:0.8489},0).wait(1).to({alpha:0.8403},0).wait(1).to({alpha:0.8253},0).wait(1).to({alpha:0.8029},0).wait(1).to({alpha:0.7723},0).wait(1).to({alpha:0.7324},0).wait(1).to({alpha:0.6823},0).wait(1).to({alpha:0.6211},0).wait(1).to({alpha:0.5487},0).wait(1).to({alpha:0.4662},0).wait(1).to({alpha:0.3767},0).wait(1).to({alpha:0.2865},0).wait(1).to({alpha:0.2036},0).wait(1).to({alpha:0.1357},0).wait(1).to({alpha:0.0874},0).wait(1).to({alpha:0.0595},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:0.0508},0).to({_off:true},1).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(899).to({_off:false},0).wait(37));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(887).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(37));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(800).to({_off:false},0).to({alpha:0},7).to({_off:true},1).wait(128));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11}]}).to({state:[]},15).wait(921));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({_off:false},0).wait(1).to({regX:1,x:121,y:-3.2},0).wait(1).to({y:-6.85},0).wait(1).to({y:-12.75},0).wait(1).to({y:-20.7},0).wait(1).to({y:-30.4},0).wait(1).to({y:-41.5},0).wait(1).to({y:-53.55},0).wait(1).to({y:-65.9},0).wait(1).to({y:-78.05},0).wait(1).to({y:-89.25},0).wait(1).to({y:-98.95},0).wait(1).to({y:-106.45},0).wait(1).to({y:-111.3},0).wait(1).to({regX:0,x:120,y:-113},0).wait(17).to({regX:1,x:121,y:-113.15},0).wait(1).to({y:-113.65},0).wait(1).to({y:-114.5},0).wait(1).to({y:-115.7},0).wait(1).to({y:-117.15},0).wait(1).to({y:-118.95},0).wait(1).to({y:-121},0).wait(1).to({y:-123.3},0).wait(1).to({y:-125.9},0).wait(1).to({y:-128.7},0).wait(1).to({y:-131.7},0).wait(1).to({y:-134.85},0).wait(1).to({y:-138.2},0).wait(1).to({y:-141.7},0).wait(1).to({y:-145.3},0).wait(1).to({y:-149},0).wait(1).to({y:-152.8},0).wait(1).to({y:-156.55},0).wait(1).to({y:-160.4},0).wait(1).to({y:-164.15},0).wait(1).to({y:-167.9},0).wait(1).to({y:-171.55},0).wait(1).to({y:-175.15},0).wait(1).to({y:-178.55},0).wait(1).to({y:-181.8},0).wait(1).to({y:-184.9},0).wait(1).to({y:-187.75},0).wait(1).to({y:-190.35},0).wait(1).to({y:-192.7},0).wait(1).to({y:-194.7},0).wait(1).to({y:-196.45},0).wait(1).to({y:-197.8},0).wait(1).to({y:-198.8},0).wait(1).to({y:-199.4},0).wait(1).to({regX:0,x:120,y:-199.65},0).to({_off:true},1).wait(855));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(15).to({_off:false},0).wait(1).to({regX:1,x:121,y:308.45},0).wait(1).to({y:309.8},0).wait(1).to({y:312.05},0).wait(1).to({y:315.05},0).wait(1).to({y:318.75},0).wait(1).to({y:322.95},0).wait(1).to({y:327.5},0).wait(1).to({y:332.15},0).wait(1).to({y:336.75},0).wait(1).to({y:341},0).wait(1).to({y:344.65},0).wait(1).to({y:347.5},0).wait(1).to({y:349.35},0).wait(1).to({regX:0,x:120,y:350},0).wait(17).to({regX:1,x:121,y:350.3},0).wait(1).to({y:351.25},0).wait(1).to({y:352.8},0).wait(1).to({y:354.95},0).wait(1).to({y:357.65},0).wait(1).to({y:360.85},0).wait(1).to({y:364.6},0).wait(1).to({y:368.85},0).wait(1).to({y:373.5},0).wait(1).to({y:378.6},0).wait(1).to({y:384.1},0).wait(1).to({y:389.9},0).wait(1).to({y:396},0).wait(1).to({y:402.35},0).wait(1).to({y:408.95},0).wait(1).to({y:415.7},0).wait(1).to({y:422.55},0).wait(1).to({y:429.5},0).wait(1).to({y:436.4},0).wait(1).to({y:443.3},0).wait(1).to({y:450.15},0).wait(1).to({y:456.85},0).wait(1).to({y:463.3},0).wait(1).to({y:469.55},0).wait(1).to({y:475.5},0).wait(1).to({y:481.1},0).wait(1).to({y:486.3},0).wait(1).to({y:491.05},0).wait(1).to({y:495.3},0).wait(1).to({y:499},0).wait(1).to({y:502.15},0).wait(1).to({y:504.65},0).wait(1).to({y:506.45},0).wait(1).to({y:507.6},0).wait(1).to({regX:0,x:120,y:508},0).to({_off:true},1).wait(855));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(668).to({_off:false},0).to({alpha:1},35).to({_off:true},97).wait(136));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(668).to({_off:false},0).to({alpha:0.4492},35).to({_off:true},97).wait(136));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(15).to({_off:false},0).to({_off:true},884).wait(37));
	...
	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({regX:0.4,regY:0.3,scaleX:0.9034,scaleY:0.9034,x:206.6,y:593},0).to({x:217.1},23,cjs.Ease.quadInOut).wait(7).to({y:583},45,cjs.Ease.quadInOut).wait(55).to({regX:0.2,regY:0.2,scaleX:0.4648,scaleY:0.4648,x:170.7,y:351.35},28,cjs.Ease.quadInOut).wait(114).to({regX:0.3,regY:0.3,scaleX:0.524,scaleY:0.524,x:177,y:382.6},41,cjs.Ease.quadInOut).wait(270).to({alpha:0},10).to({_off:true},1).wait(327));

	// bg1
	this.bg1 = new lib.bg_zoom_half2();
	this.bg1.name = "bg1";
	this.bg1.parent = this;
	this.bg1.setTransform(-15.85,-5.05,0.467,0.467,0,0,0,-0.1,-0.1);

	this.bg1_1 = new lib.bg_zoom_half();
	this.bg1_1.name = "bg1_1";
	this.bg1_1.parent = this;
	this.bg1_1.setTransform(-138.6,-113,0.9034,0.9034,0,0,0,-0.1,-0.1);
	this.bg1_1._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.bg1}]}).to({state:[{t:this.bg1_1}]},15).to({state:[{t:this.bg1_1}]},23).to({state:[{t:this.bg1_1}]},7).to({state:[{t:this.bg1_1}]},45).to({state:[{t:this.bg1_1}]},55).to({state:[{t:this.bg1_1}]},28).to({state:[{t:this.bg1_1}]},114).to({state:[{t:this.bg1_1}]},41).to({state:[{t:this.bg1_1}]},84).to({state:[{t:this.bg1_1}]},134).to({state:[{t:this.bg1_1}]},52).to({state:[{t:this.bg1_1}]},10).to({state:[]},1).wait(327));
	this.timeline.addTween(cjs.Tween.get(this.bg1_1).wait(15).to({_off:false},0).to({x:-128.1},23,cjs.Ease.quadInOut).wait(7).to({y:-123},45,cjs.Ease.quadInOut).wait(55).to({scaleX:0.4648,scaleY:0.4648,x:-6.85,y:-11.9},28,cjs.Ease.quadInOut).wait(114).to({scaleX:0.524,scaleY:0.524,x:-23.2,y:-26.9},41,cjs.Ease.quadInOut).wait(270).to({alpha:0},10).to({_off:true},1).wait(327));
	...
	this.ch2.setTransform(217.1,574,0.9034,0.9034,0,0,0,0.4,0.3);
	this.ch2._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.ch1_1}]}).to({state:[]},1).to({state:[{t:this.ch2}]},596).to({state:[{t:this.ch2}]},1).to({state:[{t:this.ch2}]},26).to({state:[{t:this.ch2}]},44).to({state:[{t:this.ch2}]},38).to({state:[{t:this.ch2}]},94).to({state:[]},99).wait(37));
	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(597).to({_off:false},0).wait(1).to({y:583},26,cjs.Ease.quadInOut).wait(44).to({regX:0.1,regY:0.1,scaleX:1.0765,scaleY:1.0765,x:235.05,y:674.2},38,cjs.Ease.quadInOut).wait(94).to({regX:0.2,regY:0.2,scaleX:0.4648,scaleY:0.4648,x:170.7,y:351.35},0).to({_off:true},99).wait(37));

	// bg2
	this.bg1_2 = new lib.bg_zoom_half();
	this.bg1_2.name = "bg1_2";
	this.bg1_2.parent = this;
	this.bg1_2.setTransform(-1.95,-279.15,1.27,1.27);

	this.timeline.addTween(cjs.Tween.get(this.bg1_2).to({_off:true},1).wait(596).to({_off:false,regX:-0.1,regY:-0.1,scaleX:0.9034,scaleY:0.9034,x:-128.1,y:-132},0).wait(1).to({y:-123},26,cjs.Ease.quadInOut).wait(44).to({regX:0,scaleX:1.0765,scaleY:1.0765,x:-175.9,y:-166.85},38,cjs.Ease.quadInOut).wait(94).to({regX:-0.1,scaleX:0.4648,scaleY:0.4648,x:-6.85,y:-11.9},0).to({_off:true},99).wait(37));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},887).wait(49));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},899).wait(32).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-282,-720,1042.1,1383);
// library properties:
lib.properties = {
	id: '_493_4',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1664356659179", id:"_493_4_bg"},
		{src:"images/ch_base.png?1664356659179", id:"_493_4_ch_base"},
		{src:"images/ch_face10.png?1664356659179", id:"_493_4_ch_face10"},
		{src:"images/ch_face11.png?1664356659179", id:"_493_4_ch_face11"},
		{src:"images/ch_face12.png?1664356659179", id:"_493_4_ch_face12"},
		{src:"images/ch_face2.png?1664356659179", id:"_493_4_ch_face2"},
		{src:"images/ch_face3.png?1664356659179", id:"_493_4_ch_face3"},
		{src:"images/ch_face4.png?1664356659179", id:"_493_4_ch_face4"},
		{src:"images/ch_face5.png?1664356659179", id:"_493_4_ch_face5"},
		{src:"images/ch_face6.png?1664356659179", id:"_493_4_ch_face6"},
		{src:"images/ch_face7.png?1664356659179", id:"_493_4_ch_face7"},
		{src:"images/ch_face8.png?1664356659179", id:"_493_4_ch_face8"},
		{src:"images/ch_face9.png?1664356659179", id:"_493_4_ch_face9"},
		{src:"images/finish.jpg?1664356659179", id:"_493_4_finish"},
		{src:"images/finish_blur.jpg?1664356659179", id:"_493_4_finish_blur"},
		{src:"images/tie_fp.png?1664356659179", id:"_493_4_tie_fp"},
		{src:"images/tie_sp.png?1664356659179", id:"_493_4_tie_sp"}
	],
	preloads: []
};
